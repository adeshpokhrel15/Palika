...
import '../../providers/Core/FormController.dart';
...
class _personalFormState extends State<personalForm> {
  ...
  String uuid = '';
  HomeHiveModel formModel = HomeHiveModel(
    homeaddress: "",
    homename: "Choose a person",
    homeid: "",
  );
                ...
                children: [
                  Consumer(builder: (context, ref, child) {
                    return ref.watch(personalControllerProvider).when(
                          data: (data) {
                            return DropdownButtonFormField<HomeHiveModel>(
                              items: [
                                ...data.map(
                                  (e) => DropdownMenuItem(
                                    value: e,
                                    child: Text(e.homename!),
                                  ),
                                ),
                              ],
                              onChanged: (value) {
                        ...
                        onTap: () {
                          picker.showCupertinoDatePicker(
                            ...
                            onDateChanged: (newDate) {
                              setState(() {
                                dobController.text = newDate.toIso8601String();
                              });
                              dobController.text = newDate.toIso8601String();
                            },
                          );
                    ...
                    builder: (context, snap) {
                      if (snap.hasData) {
                        ...
                        return DropdownButtonFormField<Gender>(
                            ...
                            onChanged: (value) {
                              genderPersonal.text = value!.nepalNamegender;
                    ...
                    builder: (context, snap) {
                      if (snap.hasData) {
                        ...
                        return DropdownButtonFormField<BloodGroup>(
                            ...
                            onChanged: (value) {
                              bloodgroupPersonal.text = value!.bloodname;
                      ...
                      onPressed: () async {
                        ...
                        if (check == null) {
                          final personalForm = PersonalHiveModel(
                            ...
                            agepersonal: int.parse(ageController.text.trim()),
                            handicappedIDPersonal: htiController.text.trim(),
                            genderpersonal: genderPersonal.text.trim(),
                            bloodgroupPersonal: bloodgroupPersonal.text,
                            dateofbirthpersonal: dobController.text,
                          );
                          List<PersonalHiveModel> listForm = [];
                          listForm.add(personalForm);
                          await ref.watch(dbProvider).saveData(
                              dbKey: mainList, data: jsonEncode(listForm));
                        } else {
                          ...
                          List<PersonalHiveModel> listForm = result
                              .map((e) => PersonalHiveModel.fromJson(e))
                              .toList();
                          // result
                          //     .map((e) => PersonalHiveModel.fromJson(e))
                          //     .toList();
