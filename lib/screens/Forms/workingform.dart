...
import '../../models/Api Models/jobTypes.dart';
import '../../providers/Api Providers/jobTypesProvider.dart';
                              ...
                              builder: (context, snap) {
                                if (snap.hasData) {
                                  ...
                                  return DropdownButtonFormField<Jobtypes>(
                                      ...
                                      onChanged: (value) {
                                        jobtype.text = value!.jobtypeNepaliname;
                                      });
                                } else {
                              ...
                              child: MaterialButton(
                                onPressed: () async {
                                  ...
                                  final workingForm = WorkingHiveModel(
                                      ...
                                      joborganization:
                                          joborganizationController.text.trim(),
                                      organizationaddress:
