...
part of 'finalModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class FinalformModelAdapter extends TypeAdapter<FinalformModel> {
  @override
  final int typeId = 20;

  @override
  FinalformModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, FinalformModel obj) {
    writer
      ..writeByte(129)
      ..writeByte(0)
      ..write(obj.firstname)
  ...
  bool operator ==(Object other) =>
      ...
      other is FinalformModelAdapter &&
